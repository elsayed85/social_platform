...
use App\Logic\ServiceForm\FacebookServiceForm;
use App\Logic\ServiceForm\TenorServiceForm;
use App\Logic\ServiceForm\TwitterServiceForm;
use App\Logic\ServiceForm\UnsplashServiceForm;
...
class Services
{
    ...
    {
        return $this->config->get('social.cache_prefix') . ".services.$key";
    }
